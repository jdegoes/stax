...
class AcceptNodeConstants {
    public static var FILTER_ACCEPT = 1;
    public static var FILTER_REJECT = 2;
    public static var FILTER_SKIP =   1;
}
...
class RangeExceptionCode {
    public static var BAD_BOUNDARYPOINTS_ERR = 1;
    public static var INVALID_NODE_TYPE_ERR =  2;
}
...
//TODO Test this function to see if it calls itself without needing the ();  See below for other similar cases
